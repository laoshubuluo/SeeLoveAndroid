...
import com.tianyu.seelove.utils.StorageUtil;
import java.io.File;
    ...
    private boolean handleException(Throwable ex) {
        ...
        if (isFrist) {
            ...
            new Thread() {
                ...
                public void run() {
                    Looper.prepare();
                    // ToastCustom.makeText(mContext, "很抱歉,程序出现异常,即将退出。", Toast.LENGTH_SHORT).show();
                    Looper.loop();
                }
            }.start();
            //收集设备参数信息
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                String path = StorageUtil.getLogDirectory(mContext) + File.separator + "crash" + File.separator;
