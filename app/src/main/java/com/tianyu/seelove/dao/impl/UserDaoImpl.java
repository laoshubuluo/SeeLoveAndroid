...
public class UserDaoImpl implements UserDao {
    ...
    private SLUser parseUserFromCursor(Cursor cursor) {
        ...
        user.setCityCode(cursor.getString(cursor.getColumnIndexOrThrow("CityCode")));
        user.setCityName(cursor.getString(cursor.getColumnIndexOrThrow("CityName")));
        user.setWorkCode(cursor.getString(cursor.getColumnIndexOrThrow("WorkCode")));
        user.setWorkName(cursor.getString(cursor.getColumnIndexOrThrow("WorkName")));
        user.setEducationCode(cursor.getString(cursor.getColumnIndexOrThrow("EducationCode")));
        user.setEducationName(cursor.getString(cursor.getColumnIndexOrThrow("EducationName")));
        user.setHouseCode(cursor.getString(cursor.getColumnIndexOrThrow("HouseCode")));
        user.setHouseName(cursor.getString(cursor.getColumnIndexOrThrow("HouseName")));
        user.setMarriageCode(cursor.getString(cursor.getColumnIndexOrThrow("MarriageCode")));
