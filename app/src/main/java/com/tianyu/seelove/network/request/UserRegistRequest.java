...
import com.tianyu.seelove.model.entity.network.request.UserRegistActionInfo;
 ...
 */
public class UserRegistRequest extends PostJsonRequest {
    private String userName;
    private String dataFromOtherPlatform;// 第三方平台返回的用户信息体

    public UserRegistRequest(Handler handler, Context context, String userName, String dataFromOtherPlatform) {
    ...
    protected String getParamsJson() {
        UserRegistActionInfo actionInfo = new UserRegistActionInfo(RequestCode.USER_CREATE, userName, dataFromOtherPlatform);
    ...
    protected void responseSuccess(JSONObject response) {
        ...
        try {
            ...
            if (ResponseConstant.SUCCESS == info.getStatusCode()) {
                ...
                msg.what = MessageSignConstant.USER_REGIST_SUCCESS;
                msg.setData(b);
            ...
            //响应失败
                ...
                msg.what = MessageSignConstant.USER_REGIST_FAILURE;
                msg.setData(b);
                handler.sendMessage(msg);
